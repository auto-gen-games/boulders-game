  ...
  val tests: Tests =
    utest.Tests {
      ...
      "maze loading" - {
        ...
        "set walls" - {
          val maze1 = Level.empty("base", 0, 2, 2, GridPoint(1, 0), GridPoint(0, 0), GridPoint(0, 1))
        ...
        "load walls A" - {
          ...
          val level     = Level.levelFromCode("base", 0, levelCode)
      ...
      "level flipping" - {
        "flip maze" - {
          val levelCode = "3,3;0,2;2,0;1,0;CdACAAFED"
          val level     = Level.levelFromCode("base", 0, levelCode)
